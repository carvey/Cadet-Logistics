...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ClassEvent_attended_list', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('classevent', models.ForeignKey(orm[u'attendance.classevent'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique('ClassEvent_attended_list', ['classevent_id', 'user_id'])

        # Adding M2M table for field required_companies on 'ClassEvent'
        db.create_table('ClassEvent_required_companies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('classevent', models.ForeignKey(orm[u'attendance.classevent'], null=False)),
            ('company', models.ForeignKey(orm[u'eagletrack.company'], null=False))
        ))
        db.create_unique('ClassEvent_required_companies', ['classevent_id', 'company_id'])

        # Adding M2M table for field required_ms_levels on 'ClassEvent'
        db.create_table('ClassEvent_required_ms_levels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('classevent', models.ForeignKey(orm[u'attendance.classevent'], null=False)),
            ('mslevel', models.ForeignKey(orm[u'eagletrack.mslevel'], null=False))
        ))
        db.create_unique('ClassEvent_required_ms_levels', ['classevent_id', 'mslevel_id'])
        ...
        db.create_table('LabEvent_attended_list', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('labevent', models.ForeignKey(orm[u'attendance.labevent'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique('LabEvent_attended_list', ['labevent_id', 'user_id'])

        # Adding M2M table for field required_companies on 'LabEvent'
        db.create_table('LabEvent_required_companies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('labevent', models.ForeignKey(orm[u'attendance.labevent'], null=False)),
            ('company', models.ForeignKey(orm[u'eagletrack.company'], null=False))
        ))
        db.create_unique('LabEvent_required_companies', ['labevent_id', 'company_id'])

        # Adding M2M table for field required_ms_levels on 'LabEvent'
        db.create_table('LabEvent_required_ms_levels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('labevent', models.ForeignKey(orm[u'attendance.labevent'], null=False)),
            ('mslevel', models.ForeignKey(orm[u'eagletrack.mslevel'], null=False))
        ))
        db.create_unique('LabEvent_required_ms_levels', ['labevent_id', 'mslevel_id'])
        ...
        db.create_table('GenericEvent_attended_list', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('genericevent', models.ForeignKey(orm[u'attendance.genericevent'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique('GenericEvent_attended_list', ['genericevent_id', 'user_id'])

        # Adding M2M table for field required_companies on 'GenericEvent'
        db.create_table('GenericEvent_required_companies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('genericevent', models.ForeignKey(orm[u'attendance.genericevent'], null=False)),
            ('company', models.ForeignKey(orm[u'eagletrack.company'], null=False))
        ))
        db.create_unique('GenericEvent_required_companies', ['genericevent_id', 'company_id'])

        # Adding M2M table for field required_ms_levels on 'GenericEvent'
        db.create_table('GenericEvent_required_ms_levels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('genericevent', models.ForeignKey(orm[u'attendance.genericevent'], null=False)),
            ('mslevel', models.ForeignKey(orm[u'eagletrack.mslevel'], null=False))
        ))
        db.create_unique('GenericEvent_required_ms_levels', ['genericevent_id', 'mslevel_id'])
