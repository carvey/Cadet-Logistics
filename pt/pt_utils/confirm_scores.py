...
def make_calculator_request(pu, su, ru, age, gender):
    """
    ...
    return parse_request(requests.post('http://apftscore.com/score.php', headers=header, data=payload))
