...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Platoon.name'
        db.add_column('Platoon', 'name',
                      self.gf('django.db.models.fields.CharField')(default='1st Platoon', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Platoon.name'
        db.delete_column('Platoon', 'name')
