...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cadet.contracted'
        db.add_column('Cadet', 'contracted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Cadet.smp'
        db.add_column('Cadet', 'smp',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Cadet.dropped'
        db.add_column('Cadet', 'dropped',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Cadet.commissioned'
        db.add_column('Cadet', 'commissioned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cadet.contracted'
        db.delete_column('Cadet', 'contracted')

        # Deleting field 'Cadet.smp'
        db.delete_column('Cadet', 'smp')

        # Deleting field 'Cadet.dropped'
        db.delete_column('Cadet', 'dropped')

        # Deleting field 'Cadet.commissioned'
        db.delete_column('Cadet', 'commissioned')
